...
<%
    ...
    String searchMonth = month.substring(5);
    //b.writeLog("月份:"+searchMonth);
    //获取人员名称
...
<div id="div1">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr id="trr2">
            ...
            if(compareResult&&leaderId.equals(String.valueOf(user.getUID()))){
            //可以查询
            ...
            double basicWorkTime = (cnt2 * 7.5 + cnt3 * 6.5+ cnt4*7.5); //基本工时
            ...
            "hrmdepartment hde ON hre.departmentid=hde.id WHERE hre.accounttype !=1 and hre.departmentid= '"+user.getUserDepartment()+"' AND CASE WHEN hre.startdate is NULL " +
            ...
            if(areaResult!=null && areaResult.size()>0){
                ...
                for (String key : keySet) {
                    ...
                    if (value.size() > 0) {
                        ...
                        //调休工时
                        String paidLeaveTimeSql  =  "SELECT nvl(SUM(overtime_hours),0.00) FROM uf_WorkOvertime WHERE break_off = 0 AND WORK_DATE LIKE '%" + month + "%' AND userid=(select id from hrmresource where workcode like '%" + workCode + "%')";
