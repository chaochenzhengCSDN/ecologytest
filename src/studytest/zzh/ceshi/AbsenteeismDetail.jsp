...
<table style="width:95%;margin:2%;" border="0" cellpadding="0" cellspacing="0">
            ...
            while (rs.next()) {
                ...
                try {
                    ...
                    for (String valueDate : finalDateList) {
                        ...
                        int attendancestatus = getId1(attendanceSql);
                    ...
                    if (!startDate.equals(endDate)) {
                        ...
                        int startDateStatus=getId1(startDateStatusSql);
                        ...
                        int endDateStatus=getId1(endDateStatusSql);
                        if(endDateStatus==0){
                            //正常出勤1天
                            startTime="08:30";
    ...
    <%!
        public static void changeTodayTime(Map<String, List<String>> value, String startTime, String endTime, String outdate,String leaveinFlag,String leaveoutFlag) {
            ...
            //b.writeLog("result13结果为:" + result13);
            ...
            if (result2) {
                ...
                if(value.containsKey(outdate)){
                    String signEndTime=gooutStartDate.size()<=1?"":gooutStartDate.get(1);
                    //b.writeLog(signEndTime+"<<<>>>"+startTime);
                    if(signEndTime.compareTo(startTime)<0){
                        gooutStartDate.add(startTime);
                        gooutStartDate.add(endTime);
                    }
                }else{
