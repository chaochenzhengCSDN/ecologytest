...
<div id="div1">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr id="trr2">
            ...
            boolean compareResult= month.compareTo(lastmonth) == 0&&month.compareTo("2020-09")>=0;
            ...
            if(areaResult!=null && areaResult.size()>0){
                ...
                for (String key : keySet) {
                    ...
                    if (value.size() > 0) {
                        ...
                        String annualInfoSql = "select total_days,used_days,DECODE(total_days-used_days,null,0,total_days-used_days) spareHours from uf_annual_info where userid=(select id from hrmresource where workcode like '%" + workCode + "%')  ";
